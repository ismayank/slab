...
mobility.SetPositionAllocator (positionAlloc);
  ...
  // mobility.SetMobilityModel ("ns3::RandomWalk2dMobilityModel","Bounds", RectangleValue (Rectangle (-50, 50, -50, 50)), "Distance",DoubleValue(50.0),"Speed",StringValue(speed));
     //mobility.SetMobilityModel  ("ns3::RandomWalk2dMobilityModel","Bounds", RectangleValue (Rectangle (-50, 50, -50, 50)),"Speed",StringValue(speed));
...
//no reply  from node 9 to node 3
 ...
 /*
    ...
    /*
    OnOffHelper server("ns3::UdpSocketFactory", (InetSocketAddress(interfaces1.GetAddress(0), 9)));
    server.SetAttribute("PacketSize", UintegerValue(payloadSize));
    server.SetAttribute("OnTime", StringValue("ns3::ConstantRandomVariable[Constant=1]"));
    server.SetAttribute("OffTime", StringValue("ns3::ConstantRandomVariable[Constant=0]"));
    server.SetAttribute("DataRate", DataRateValue(DataRate(dataRate)));
    ApplicationContainer serverApp = server.Install(c.Get(12);
...
Ipv4GlobalRoutingHelper::PopulateRoutingTables ();
  ...
  AnimationInterface anim ("darling.xml");
