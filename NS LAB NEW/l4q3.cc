...
LogComponentEnable ("OnOffApplication", LOG_LEVEL_INFO);
 ...
 multicast.AddMulticastRoute (multicastRouter1, multicastSource, 
  ...
  ApplicationContainer sinkC = sink.Install (c2.Get (1)); // Node n5
  // Start the sink
  ...
  anim.SetConstantPosition(c.Get(1),15,20);
  anim.SetConstantPosition(c.Get(2),20,20);
  anim.SetConstantPosition(c.Get(3),25,20);
  anim.SetConstantPosition(c.Get(4),30,20);
  anim.SetConstantPosition(c.Get(5),65,20);
  anim.SetConstantPosition(c.Get(6),70,20);
  anim.SetConstantPosition(c.Get(7),75,20);
